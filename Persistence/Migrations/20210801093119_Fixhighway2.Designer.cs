...
namespace Persistence.Migrations
{
    ...
    [Migration("20210801093119_Fixhighway2")]
    partial class Fixhighway2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Highway.DetectedCarBySpeedCam", b =>
                {
                    ...
                    b.Property<double>("DetectedSpeed")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Entities.Car", b =>
                {
                    b.HasOne("Entities.Background.CarInHighway", "CarInHighway")
                        .WithOne("Car")
                        .HasForeignKey("Entities.Car", "CarInHighwayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
